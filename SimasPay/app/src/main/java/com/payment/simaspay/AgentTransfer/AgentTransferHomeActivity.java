...
public class AgentTransferHomeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agent.setTypeface(Utility.HelveticaNeue_Medium(AgentTransferHomeActivity.this));
...
//        name.setText(sharedPreferences.getString("userName",""));
        ...
        pembayaran_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(AgentTransferHomeActivity.this, PaymentAndPurchaseAccountTypeActivity.class);
        ...
        flashiz_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AgentTransferHomeActivity.this, PayByQRActivity.class);
                startActivity(intent);
            }
        });
