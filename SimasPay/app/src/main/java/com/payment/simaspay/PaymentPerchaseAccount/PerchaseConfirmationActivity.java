...
public class PerchaseConfirmationActivity extends AppCompatActivity implements IncomingSMS.AutoReadSMSListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IncomingSMS.setListener(PerchaseConfirmationActivity.this);
    ...
    class PurchaseConfirmationAsynTask extends AsyncTask<Void, Void, Void> {
        String response;
    ...
    private void showOTPRequiredDialog() {
        ...
        dialogBuilder = new AlertDialog.Builder(PerchaseConfirmationActivity.this, R.style.MyAlertDialogStyle).create();
