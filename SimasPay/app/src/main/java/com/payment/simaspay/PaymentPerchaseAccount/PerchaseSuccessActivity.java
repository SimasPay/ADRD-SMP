 ...
 */
public class PerchaseSuccessActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number_field.setText("Rp.  "+getIntent().getExtras().getString("amount"));
        ...
        title.setTypeface(Utility.Robot_Regular(PerchaseSuccessActivity.this));
        heading.setTypeface(Utility.Robot_Regular(PerchaseSuccessActivity.this));
        name.setTypeface(Utility.Robot_Regular(PerchaseSuccessActivity.this));
        name_field.setTypeface(Utility.Robot_Light(PerchaseSuccessActivity.this));
        number.setTypeface(Utility.Robot_Regular(PerchaseSuccessActivity.this));
        number_field.setTypeface(Utility.Robot_Light(PerchaseSuccessActivity.this));
        amount.setTypeface(Utility.Robot_Regular(PerchaseSuccessActivity.this));
        amount_field.setTypeface(Utility.Robot_Light(PerchaseSuccessActivity.this));
