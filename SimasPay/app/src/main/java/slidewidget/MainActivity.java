...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mSliderProgress, teksnya;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teksnya=(TextView)findViewById(R.id.teksnya);
        mSliderView.setListener(new SliderView.SliderListener() {
            ...
            public void onSlide(float progress, SliderState state) {
                ...
                //float pre = (progress/100)*teksnya.getMeasuredWidth();
                //int currentWidth=teksnya.getMeasuredWidth()-(int)Math.round(pre);
                //Log.d("Test","width:" + currentWidth);
                //mSliderView.setScaleX(progress);
                //teksnya.setWidth(currentWidth);
                switch (state) {
                    case OPENED:
