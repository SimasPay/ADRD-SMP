...
//            Utility.displayDialog(getResources().getString(R.string.SMS_notreceived_message), LakuPandaiTransferConfirmationActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(LakuPandaiTransferConfirmationActivity.this);
   ...
   /* public void SMSAlert(final String string) {
    ...
    class InterBankLakuPandaiAsynTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            mapContainer.put(Constants.PARAMETER_DEST_MDN, getIntent().getExtras().getString("Acc_Number"));
            ...
            WebServiceHttp webServiceHttp = new WebServiceHttp(mapContainer, LakuPandaiTransferConfirmationActivity.this);
            ...
            if (response != null) {
                ...
                if (msgCode == 631) {
                    ...
                    if (responseContainer.getMsg() == null) {
                        Utility.networkDisplayDialog(
                                ...
                                LakuPandaiTransferConfirmationActivity.this);
                    } else {
                        Utility.networkDisplayDialog(
                                responseContainer.getMsg(), LakuPandaiTransferConfirmationActivity.this);
                    }
                }
            } else {
                if (progressDialog != null) {
                ...
                Utility.networkDisplayDialog(sharedPreferences.getString(
                        ...
                        getResources().getString(
                                R.string.bahasa_serverNotRespond)), LakuPandaiTransferConfirmationActivity.this);
            }
        }
    }
}
