...
public class JustifiedTextView extends View {
    ...
    Typeface font;
    int textColor;
    float textSize = 27f, lineHeight = 25f, wordSpacing = 5f, lineSpacing = 10f;
    float onBirim, w, h;
    ...
    private void init() {
        ...
        textColor = getResources().getColor(R.color.timer_color);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (font != null) {
            font = Typeface.createFromAsset(getContext().getAssets(), "Roboto_Regular.ttf");
