...
//			System.out.println("Testing>>Xhigh" + metrics.densityDpi);
	...
	// class CheckMDNExist extends AsyncTask<Void, Void, Void> {
	// @Override
	// protected void onPreExecute() {
	// dialog = ProgressDialog.show(context,
	// "  Uangku               ",context.getResources().getString(R.string.eng_loading),
	// true);
	...
	//
	//
	// parameters="SERVICENAME=CHECKMOBILENO"+"&MOBILENUMBER="+com.uangku.emoney.services.Constants.SOURCE_MDN_NAME;
	// json=getResponseSSLCertificatation(parameters);
	// System.out.println("Pramod "+json);
	//
	// //Http
	// //json=getHttpresponse(parameters);
	// System.out.println("Pramod "+json);
	//
	// /*try {
	// parameters="SERVICENAME=CHECKMOBILENO"+"&MOBILENUMBER="+com.uangku.emoney.services.Constants.SOURCE_MDN_NAME;
	...
	// alertbox.setMessage(context.getResources().getString(R.string.eng_serverNotRespond));
	...
	// }else{
	// try {
	// responseContainer = obj.parse(json);
	// refNo=responseContainer.getReferenceNo();
	// errorCode=responseContainer.getErrorCode();
	// if(errorCode.equalsIgnoreCase("0")||errorCode.equalsIgnoreCase("-87")){
	// Intent intent = new Intent(context, KycRegistration.class);
	// intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
	// intent.putExtra("SCREEN", "KycRegistration");
	// intent.putExtra("FROM_SCREEN", Utility.fromScreen);
	// context.startActivity(intent);
	// }else{
	// Intent intent = new Intent(context, KycRegistrationSuccess.class);
	// intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
	// intent.putExtra("SCREEN", "KycRegistration");
	// intent.putExtra("ERROR_CODE", errorCode);
	// intent.putExtra("REFERENCE_NO", refNo);
	// intent.putExtra("MDN_CHECK", "mdncheck");
	// intent.putExtra("FROM_SCREEN", Utility.fromScreen);
	// context.startActivity(intent);
	// }
	// } catch (Exception e) {
...
//				Log.i("Nav", "version res:: " + line);
	...
	public static String getHttpresponse(String params) {
		...
		try {
			 ...
			 * HttpEntity entity = response.getEntity(); is =
			 * entity.getContent();
			 */
			...
			HttpPost httpPost = new HttpPost(AppConfigFile.kycServerUrl
					+ params);
//			System.out.println(AppConfigFile.kycServerUrl + params);
	...
	public static void ShowDialog(String str, Context ctx) {
		AlertDialog.Builder builder = new AlertDialog.Builder(ctx);
		builder.setTitle("Uangku");
	...
	/*public static void wrongPinDialog(String msg, Context ctx) {
	...
	// Insufficient Funds
	/*public static void insufficientFundsDialog(String msg, Context ctx) {
