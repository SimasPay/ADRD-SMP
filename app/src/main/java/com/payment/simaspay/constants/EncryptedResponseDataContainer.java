...
public class EncryptedResponseDataContainer {
    ...
    private String isBank,isEmoney, isLakuPandai, isKyc, CustomerType, ReceiverAccountName;
    ...
    private String province,district,subDistrict,city,mothersMaidenName,transactionId,addressLine,rt,rw,postalCode,dob;
