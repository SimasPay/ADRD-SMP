...
public class TransferEmoneyToEmoneyConfirmationActivity extends AppCompatActivity implements IncomingSMS.AutoReadSMSListener{
    ...
    private class TransferConfirmationAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            Drawable drawable = new ProgressBar(TransferEmoneyToEmoneyConfirmationActivity.this).getIndeterminateDrawable().mutate();
            drawable.setColorFilter(ContextCompat.getColor(TransferEmoneyToEmoneyConfirmationActivity.this, R.color.red_sinarmas),
