...
/**
 * Created by Nagendra P on 1/25/2016.
 */
public class ArealData {

    String id_province, province_name, id_region, region_name, id_district, district_name, id_village, village_name;
    ...
    public String getId_village() {
        return id_village;
    }

    public void setId_village(String id_village) {
