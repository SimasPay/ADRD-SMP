...
public class SimpleMonthView extends View {
    ...
    private static final int SELECTED_CIRCLE_ALPHA = 100;
	...
	public SimpleMonthView(Context context) {
		...
		mDayTextColor = resources.getColor(R.color.color_4);
	...
	private void drawMonthDayLabels(Canvas canvas) {
        ...
        for (int i = 0; i < mNumDays; i++) {
            ...
            canvas.drawText(mDateFormatSymbols.getShortWeekdays()[mDayLabelCalendar.get(Calendar.DAY_OF_WEEK)].toUpperCase(Locale.getDefault()).substring(0,1), x, y, mMonthDayLabelPaint);
        }
	}

	private void drawMonthTitle(Canvas canvas) {
        int x = (mWidth + 2 * mPadding) / 2;
        int y = (MONTH_HEADER_SIZE - MONTH_DAY_LABEL_TEXT_SIZE) / 2 + (MONTH_LABEL_TEXT_SIZE / 3)-5;
	...
	protected void drawMonthNums(Canvas canvas) {
		int y = (mRowHeight + MINI_DAY_NUMBER_TEXT_SIZE) / 2 - DAY_SEPARATOR_WIDTH + MONTH_HEADER_SIZE+5;
...
//				mMonthNumPaint.setColor(mTodayNumberColor);
	...
	protected void initView() {
        ...
        mMonthTitlePaint.setTypeface(Utils.Robot_Regular(context1));
        ...
        mMonthTitleBGPaint.setTypeface(Utils.Robot_Regular(context1));
...
//        mSelectedCirclePaint.setAntiAlias(true);
        ...
        mSelectedCirclePaint.setTypeface(Utils.Robot_Regular(context1));
//        mSelectedCirclePaint.setAlpha(SELECTED_CIRCLE_ALPHA);
        ...
        mMonthDayLabelPaint.setTypeface(Utils.Robot_Regular(context1));
        mMonthDayLabelPaint.setTextAlign(Align.CENTER);
        mMonthDayLabelPaint.setFakeBoldText(true);

        mMonthNumPaint = new Paint();
        mMonthNumPaint.setAntiAlias(true);
        mMonthNumPaint.setTextSize(MONTH_DAY_LABEL_TEXT_SIZE);
        mMonthNumPaint.setStyle(Style.FILL);
        mMonthNumPaint.setTextAlign(Align.CENTER);
        mMonthNumPaint.setTypeface(Utils.Robot_Regular(context1));
