...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
	...
	private Button mDoneButton,CancelButton;
	...
	public static DatePickerDialog newInstance(Context context1,OnDateSetListener onDateSetListener, int year, int month, int day) {
		context=context1;
		return newInstance(context1,onDateSetListener, year, month, day, true);
	}

	public static DatePickerDialog newInstance(Context context1,OnDateSetListener onDateSetListener, int year, int month, int day, boolean vibrate) {
	...
	private void updateDisplay(boolean announce) {
		...
		if (this.mDayOfWeekView != null){
			...
			this.mDayOfWeekView.setTypeface(Utils.Robot_Light(context));
		}

		this.mSelectedMonthTextView.setText(mDateFormatSymbols.getMonths()[this.mCalendar.get(Calendar.MONTH)]);
		this.mSelectedMonthTextView.setTypeface(Utils.Robot_Regular(context));

		mSelectedDayTextView.setText(DAY_FORMAT.format(mCalendar.getTime()));
		mYearView.setText(YEAR_FORMAT.format(mCalendar.getTime()));

		mSelectedDayTextView.setTypeface(Utils.Robot_Regular(context));
		mYearView.setTypeface(Utils.Robot_Regular(context));
	...
	public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
		...
		mDoneButton.setTypeface(Utils.Robot_Medium(context));
		CancelButton.setTypeface(Utils.Robot_Medium(context));
		...
		try {
			mDayOfWeekView.setTypeface(Utils.Robot_Regular(context));
		} catch (Exception e) {
			e.printStackTrace();
		}
